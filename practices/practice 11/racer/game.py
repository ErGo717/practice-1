...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, coins):
        COIN.earn_point()
        try:
            pygame.mixer.Sound("chieuk-coin-257878.mp3").play()
        except pygame.error:
            print("[Error]: coin sound file not found or cannot be played.")

    # Enemy collision
    if pygame.sprite.spritecollideany(P1, enemies):
        try:
            pygame.mixer.Sound("tunetank.com_metal-crash-and-debris.wav").play()
        except pygame.error:
            print("[Error]: crash sound file not found or cannot be played.")
